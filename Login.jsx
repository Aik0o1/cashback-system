...
export default function Login() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100">
      ...
      <header className="bg-white border-b border-zinc-200 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex items-center">
          ...
          <span className="ml-4 text-zinc-600 font-medium">Login</span>
        </div>
      </header>
      ...
      <main className="container mx-auto px-6 py-12 flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-2xl flex items-end">
              <div className="p-8 text-white">
                ...
                <p className="text-zinc-200">
                  Faça login para aproveitar os melhores cashbacks da região.
                </p>
              </div>
            </div>
          </div>
        ...
        <Card className="lg:w-1/3 p-8 bg-white/50 backdrop-blur border border-white/20 ml-[-500px]">
  <div className="text-center space-y-4 mb-8">
    <h2 className="text-2xl font-bold text-zinc-800">Entrar como</h2>
  ...
  <div className="space-y-4">
    <a href="/loginUsuario" className="block">
      <Button
    ...
    <a href="/empresarioLogin" className="block">
      <Button
        variant="outline"
