...
function Loja() {
  ...
  return (
    <div className="container min-h-screen fundo-login max-w-full">
      <header className="bg-lime-950 p-6 text-white flex justify-between items-center">
        ...
        <div className="relative">
          <input
            ...
            className="px-4 py-2 rounded-md text-black focus:outline-none focus:ring-2 focus:ring-lime-600"
          />
